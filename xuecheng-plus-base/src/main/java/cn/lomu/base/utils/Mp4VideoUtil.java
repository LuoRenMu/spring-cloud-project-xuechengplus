...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\code\\software\\ffmpeg-master-latest-win64-gpl-shared\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "A:\\video\\2023-05-15 23-17-21.mkv";
        //转换后mp4文件的路径
        String mp4_path = "A:\\video\\123.mp3";
        //创建工具类对象
